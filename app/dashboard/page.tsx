...
export default async function DashboardHome() {
    ...
    // Mock data for active users (replace with real data from database)
    const mockUserData = {
        dusScore: 67.5,
        preferencesFilled: 18,
        totalPreferences: 30,
        expectedPlacement: "İstanbul Üniversitesi - Ortodonti",
        daysUntilDeadline: 23,
        riskLevel: "balanced" as "balanced" | "ambitious" | "safe" | "incomplete",
        recentChanges: [
            { program: "Ankara Ü. - Endodonti", change: "up" as const, percentage: 5 },
            { program: "Ege Ü. - Ortodonti", change: "down" as const, percentage: 3 },
        ],
        savedScenarios: 3,
    };
    ...
    const riskInfo = getRiskLevelInfo(mockUserData.riskLevel);
            ...
            <div className="max-w-7xl mx-auto p-6 sm:p-8 lg:p-12">
                ...
                <div className="mb-8">
                    ...
                    <p className="text-gray-600 text-lg flex items-center gap-2">
                        <span className="inline-block w-8 h-0.5 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full"></span>
                ...
                {accountStatus !== "active" && (
                    <div className="bg-white rounded-xl border border-gray-200 p-8 mb-6">
                        <div className="flex items-center justify-between mb-8">
                            <h2 className="text-xl font-semibold text-gray-900">Hesap Durumu</h2>
                            <span
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                            ...
                            <div className="group relative bg-gradient-to-br from-green-500 to-green-600 rounded-xl p-5 overflow-hidden cursor-pointer transform transition-all duration-300 hover:scale-105 hover:shadow-xl">
                                ...
                                <div className="relative z-10">
                                    ...
                                    <div className="text-4xl font-bold text-white mb-2 group-hover:scale-110 transition-transform duration-300">
                                        {mockUserData.preferencesFilled}<span className="text-2xl text-green-100">/{mockUserData.totalPreferences}</span>
                                    </div>
                                    <div className="w-full bg-green-700/30 rounded-full h-2 overflow-hidden">
                                        <div
                                            ...
                                            style={{ width: `${(mockUserData.preferencesFilled / mockUserData.totalPreferences) * 100}%` }}
                                        />
                                    </div>
                                </div>
                            ...
                            <div className="group relative bg-gradient-to-br from-purple-500 to-purple-600 rounded-xl p-5 overflow-hidden cursor-pointer transform transition-all duration-300 hover:scale-105 hover:shadow-xl">
                                ...
                                <div className="relative z-10">
                                    ...
                                    <div className="text-sm font-semibold text-white line-clamp-2 min-h-[2.5rem] group-hover:scale-105 transition-transform duration-300">
                                        {mockUserData.expectedPlacement}
                                    </div>
                            ...
                            <div className="group relative bg-gradient-to-br from-orange-500 to-orange-600 rounded-xl p-5 overflow-hidden cursor-pointer transform transition-all duration-300 hover:scale-105 hover:shadow-xl">
                                ...
                                <div className="relative z-10">
                                    ...
                                    <div className="text-4xl font-bold text-white mb-1 group-hover:scale-110 transition-transform duration-300">
                                        {mockUserData.daysUntilDeadline}
                                    </div>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            ...
                            <div className="bg-white border border-gray-200 rounded-xl p-6">
                                ...
                                <div className={`px-4 py-3 bg-${riskInfo.color}-50 border border-${riskInfo.color}-200 rounded-lg mb-4`}>
                                    ...
                                    <p className="text-sm text-gray-700 mt-1">
                                        {mockUserData.riskLevel === "balanced" && "Tercihleriniz güvenli, hedef ve iddialı seçeneklerin iyi bir karışımını içeriyor."}
                                        {mockUserData.riskLevel === "ambitious" && "Tüm tercihleriniz düşük olasılıklı. Daha güvenli seçenekler eklemeyi düşünün."}
                                        {mockUserData.riskLevel === "safe" && "Tercihleriniz çok güvenli. Daha iyi fırsatları kaçırıyor olabilirsiniz."}
                                        {mockUserData.riskLevel === "incomplete" && "Daha fazla tercih eklemelisiniz. 30 tercih hakkınızı kullanın."}
                                    </p>
                                </div>
                                <Link
                            ...
                            <div className="bg-white border border-gray-200 rounded-xl p-6">
                                ...
                                <div className="space-y-3">
                                    {mockUserData.recentChanges.map((change, idx) => (
